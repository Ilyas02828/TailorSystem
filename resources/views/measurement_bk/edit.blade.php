                                                ...
                                                <div class="col-md-6 col-md-offset-3"> 
                                                    {!! Form::model($measurement, ['route'=>['measurements.update', $measurement->id], 'method'=>'PATCH', 'class'=>'form-horizontal m-b-30']) !!}
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">Neck گلہ</label>
                                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">Sleeve آستين</label>
                                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">Wrist کلائ</label>
                                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">length لمبائ</label>
                                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">shoulder کندھا</label>
                                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">chest سينہ</label>
                                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">Waist کمر</label>
                                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">Hips کھولہا</label>
                                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">thigh گٹھنۂ</label>
                                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">ankles ٹخنے</label>
                                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">inseam اندرونی سلائ</label>
                                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">outseam بیرونی سلائ</label>
                                                                    <div class="col-md-12">
