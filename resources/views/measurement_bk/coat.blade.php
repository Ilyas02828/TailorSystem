                                                ...
                                                <div class="col-md-6 col-md-offset-3"> 
                                                      {!! Form::model($measurement, ['route'=>['measur_coat.update', $measurement->id], 'method'=>'PATCH', 'class'=>'form-horizontal m-b-30']) !!}
                                                       ...
                                                       <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">Koler kkk</label>
                                                                    <div class="col-md-12">
                                                       ...
                                                       <div class="form-group">
                                                            <label class="col-md-12">Buttons</label>
                                                            <div class="col-md-12 ">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-12">Back Side Duble Check</label>
                                                            <div class="col-md-12 ">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="radio radio-info radio-inline">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-12">Asteen Moree</label>
                                                            <div class="col-md-12 ">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="radio radio-info radio-inline">
