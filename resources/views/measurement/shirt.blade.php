                                                ...
                                                <div class="col-md-6 col-md-offset-3"> 
                                                 {!! Form::model($measurement, ['route'=>['measur_shirt.update', $measurement->id], 'method'=>'PATCH', 'class'=>'form-horizontal m-b-30']) !!}
                                                       ...
                                                       <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">Chatiچھاتی</label>
                                                                    <div class="col-md-12">
                                                       ...
                                                       <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-12">Pati پٹی</label>
                                                            <div class="col-md-12 ">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="radio radio-info radio-inline">
                                                             ...
                                                             <div class="form-group">
                                                            <label class="col-md-12">Kaaf کف</label>
                                                            <div class="col-md-12 ">
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="radio radio-info radio-inline">
                                                              ...
                                                              <div class="form-group">
                                                            <label class="col-md-12">Aasteen آستین</label>
                                                            <div class="col-md-12 ">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="radio radio-info radio-inline">
