                                        ...
                                        <div class="portlet-body">                           
                                            <div class='row'>
                                                <div class="col-md-6 col-md-offset-3"> 
                                                      {!! Form::model($measurement, ['route'=>['measur_coat.update', $measurement->id], 'method'=>'PATCH', 'class'=>'form-horizontal m-b-30']) !!}
                                                        <div class="col-md-6">
                                                       ...
                                                       <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">Tera تھیرا</label>
                                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="col-md-12">Chati چھاتی</label>
                                                                    <div class="col-md-12">
                                                       ...
                                                       <div class="form-group">
                                                            <label class="col-md-12">Buttons بٹن</label>
                                                            <div class="col-md-12 ">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="radio radio-info radio-inline">
                                                                            {!! Form::radio('button', '2button', '', ['id'=>'inlineCheckbox0']) !!}
                                                                            <label for="inlineCheckbox0"> 2 Button </label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="radio radio-warning radio-inline">
                                                                            {!! Form::radio('button', '3button', '', ['id'=>'inlineCheckbox1']) !!}
                                                                            <label for="inlineCheckbox1"> 3 Button </label>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-12">Back Side Duble Check چک</label>
                                                            <div class="col-md-12 ">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="radio radio-info radio-inline">
                                                                            {!! Form::radio('chek', 'yes', '', ['id'=>'inlineCheckbox0']) !!}
                                                                            <label for="inlineCheckbox0"> Yes </label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="radio radio-warning radio-inline">
                                                                            {!! Form::radio('chek', 'no', '', ['id'=>'inlineCheckbox1']) !!}
                                                                            <label for="inlineCheckbox1"> No </label>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-12">Asteen Moree آستین</label>
                                                            <div class="col-md-12 ">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="radio radio-info radio-inline">
                                                                            {!! Form::radio('asteen', 'yes', '', ['id'=>'inlineCheckbox0']) !!}
                                                                            <label for="inlineCheckbox0"> Yes </label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="radio radio-warning radio-inline">
                                                                            {!! Form::radio('asteen', 'no', '', ['id'=>'inlineCheckbox1']) !!}
                                                                            <label for="inlineCheckbox1"> No </label>
                                                                        </div>
                                                                    </div>
