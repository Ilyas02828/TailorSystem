                                        ...
                                        <div class="portlet-body">                           
                                            <div class='row'>
                                                <div class="col-md-6 col-md-offset-3"> 
                                                   {!! Form::model($measurement, ['route'=>['style.update', $measurement->id], 'method'=>'PATCH', 'class'=>'form-horizontal m-b-30']) !!}
                                                         ...
                                                         <img src="{{asset('images/frontpock.png')}}" style="height: 90px; width:200px;" >
                                                            ...
                                                            <div class="col-md-12 ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="radio radio-success radio-inline">
                                                                            {!! Form::radio('galla', 'qasmi', '', ['id'=>'inlineCheckbox35']) !!}
                                                                            <label for="inlineCheckbox35"> Qasmi </label>
                                                                        </div>
                                                                    </div>
                                                                </div>      
                                                            </div>
