        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="index.html" class="logo">
                        <span>
                            <img alt="Logo" src="{{asset('images/lily-logo.png') }}"  class="thumb-md img-rounded bg-white" style="width: 40%; height:55px;"> <span>{{{ Auth::user()->name}}}</span>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">  
                     ...
                     <!--    <li class="has_sub">
                            ...
                            <i class="mdi mdi-floppy"></i><span> Measurements </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route ('orders.create') }}">Add new Measurement</a></li>
                                    <li><a href="{{ route ('orders.index') }}">Edit Old Measurement</a></li>
                                </ul>
                            </li> -->
                              
                                 <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect">
                            <i class="mdi mdi-floppy"></i><span> Naap </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled" style="font-size: 17px;">
                                 <li><a href="{{ route ('orders.create')}}">Shalwar & Qamees</a></li>
                                     <li><a href="{{route('waskat.create')}}">Waskat</a></li>
                                    <li><a href="{{route('coat.create')}}">Coat</a></li>
                                     <li><a href="{{route('pant.create')}}">Pant</a></li>
                                      <li><a href="{{route('shirt.create')}}">Shirt</a></li>

                                </ul>
                            </li>
                                  <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect">
                            <i class="mdi mdi-floppy"></i><span> Naap List </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled" style="font-size: 17px;">
                                 <li><a href="{{ route ('orders.index')}}">Shalwar & Qamees</a></li>
                                     <li><a href="{{route('waskat.index')}}">Waskat</a></li>
                                    <li><a href="{{route('coat.index')}}">Coat</a></li>
                                     <li><a href="{{route('pant.index')}}">Pant</a></li>
                                      <li><a href="{{route('shirt.index')}}">Shirt</a></li>
                            ...
                            <!--         <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-cash-multiple"></i> <span> All Orders </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{('allorders') }}">All Order List</a></li> 
                                </ul>
                            </li> -->
                            
                            <li class="menu-title">All Order</li>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-cash-multiple"></i> <span> Salary Month Base</span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                               ...
                               <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-cash-multiple"></i> <span> Salary % Base</span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{ route ('salarypercentage.create') }}">Add Salary</a></li>
                                    <li><a href="{{ route ('salarypercentage.index') }}">Salaries List</a></li>
                                </ul>
                            </li>
            ...
            <div class="content-page">
                ...
                <footer class="footer text-right">
                    {{date('Y')}} © <span class="text-danger">*ISI* TMS</span>
                     <a href="https://web.facebook.com/isi.softwaresol">
                    <span class="pull-right" >
                        <!-- <i class=" text- text-danger"></i> -->
            <img src="{{asset('images/cheetah.png')}}" style="height:2px;"> by
                         <span class="text-danger">ISI SOFTWARE SOLUTIONS Pakistan.</span></a>
                    </span>
                </footer>
