...
class ShirtController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('shirt/index')->with( 'orders', $orders );
    }
    ...
    public function create()
    {
        ...
        return view('shirt/create')->with('staff', $staff)->with('customer', $customer)
    ...
    public function store(Request $request)
    {
       ...
       Session::flash('notice','Order was successfully Created');
            return redirect()->route('measur_shirt.edit', $order->id);
        
        }
        else
        {
            Session::flash('alert','Order was not successfully Created');
            return redirect('coat/create');
        }
    }
    /**
    ...
    {
        $order = Order::find($id);
        return view('shirt/show')->with('order',$order);
    }
