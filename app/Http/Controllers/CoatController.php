...
class CoatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('coat/index')->with( 'orders', $orders );
    }
    ...
    public function create()
    {
        ...
        return view('coat/create')->with('staff', $staff)->with('customer', $customer)
    ...
    public function store(Request $request)
    {
       ...
       Session::flash('notice','Order was successfully Created');
            return redirect()->route('measur_coat.edit', $order->id);
    ...
    {
        $order = Order::find($id);
        return view('coat/show')->with('order',$order);
    }
