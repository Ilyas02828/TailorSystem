...
class PantController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pant/index')->with( 'orders', $orders );
    }
    ...
    public function create()
    {
        ...
        return view('pant/create')->with('staff', $staff)->with('customer', $customer)
    ...
    public function store(Request $request)
    {
       ...
       Session::flash('notice','Order was successfully Created');
            return redirect()->route('measur_pant.edit', $order->id);
    ...
    {
        $order = Order::find($id);
        return view('pant/show')->with('order',$order);
    }
